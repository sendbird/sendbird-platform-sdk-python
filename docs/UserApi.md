...
> InlineResponse20028 view_push_preferences_for_channel_by_url(user_id, channel_url)
...
> InlineResponse20027 view_who_owns_registration_or_device_token_by_token(token_type, token)
