...
with sendbird_platform_sdk.ApiClient() as api_client:
    ...
    user_id2 = "user_id_example" # str | (Deprecated) Restricts the search scope to only retrieve the target user's group channels. It's recommended to use the list group channels by user action instead. (optional)
