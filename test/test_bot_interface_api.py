...
from sendbird_platform_sdk.api.bot_interface_api import BotInterfaceApi  # noqa: E501


class TestBotInterfaceApi(unittest.TestCase):
    """BotInterfaceApi unit test stubs"""

    def setUp(self):
        self.api = BotInterfaceApi()  # noqa: E501
