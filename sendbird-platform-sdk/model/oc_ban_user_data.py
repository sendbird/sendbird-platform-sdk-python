...
class OcBanUserData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, channel_url, user_id, agent_id, seconds, description, *args, **kwargs):  # noqa: E501
        """OcBanUserData - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, channel_url, user_id, agent_id, seconds, description, *args, **kwargs):  # noqa: E501
        """OcBanUserData - a model defined in OpenAPI
