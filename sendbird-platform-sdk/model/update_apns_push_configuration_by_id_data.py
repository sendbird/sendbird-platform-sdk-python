...
class UpdateApnsPushConfigurationByIdData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, provider_id, apns_cert, apns_cert_env_type, apns_cert_password, has_unread_count_badge, content_available, mutable_content, push_sound, apns_type, *args, **kwargs):  # noqa: E501
        """UpdateApnsPushConfigurationByIdData - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, provider_id, apns_cert, apns_cert_env_type, apns_cert_password, has_unread_count_badge, content_available, mutable_content, push_sound, apns_type, *args, **kwargs):  # noqa: E501
        """UpdateApnsPushConfigurationByIdData - a model defined in OpenAPI
