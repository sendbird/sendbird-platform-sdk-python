...
class UserApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_user_metadata_endpoint = _Endpoint(
            ...
            root_map={
                ...
                'location_map': {
                    'user_id': 'path',
                    'api_token': 'header',
                    'create_user_metadata_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.delete_specific_user_metadata_endpoint = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [],
                'endpoint_path': '/v3/users/{user_id}/metadata/{key}',
                'operation_id': 'delete_specific_user_metadata',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.delete_user_all_metadata_endpoint = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [],
                'endpoint_path': '/v3/users/{user_id}/metadata',
                'operation_id': 'delete_user_all_metadata',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.update_specific_user_metadata_endpoint = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [],
                'endpoint_path': '/v3/users/{user_id}/metadata/{key}',
                'operation_id': 'update_specific_user_metadata',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
                'all': [
                    ...
                    'key',
                    'api_token',
                    'update_specific_user_metadata_request',
                ],
                'required': [
                    'user_id',
                    'key',
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'key': 'path',
                    'api_token': 'header',
                    'update_specific_user_metadata_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.update_user_metadata_endpoint = _Endpoint(
            ...
            root_map={
                ...
                'location_map': {
                    'user_id': 'path',
                    'api_token': 'header',
                    'update_user_metadata_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.view_specific_user_metadata_endpoint = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [],
                'endpoint_path': '/v3/users/{user_id}/metadata/{key}',
                'operation_id': 'view_specific_user_metadata',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def create_user_metadata(
        ...
        **kwargs
        ...
        """Create user metadata  # noqa: E501

        ## Create metadata When creating new items of the user metadata. https://sendbird.com/docs/chat/platform-api/v3/user/managing-metadata/user-create-metadata  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        Keyword Args:
            api_token (str): [optional]
            create_user_metadata_request (CreateUserMetadataRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
    ...
    def delete_specific_user_metadata(
        self,
        user_id,
        key,
        **kwargs
    ):
        """Delete user metadata  # noqa: E501

        ## Delete metadata https://sendbird.com/docs/chat/platform-api/v3/user/managing-metadata/user-delete-metadata  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_specific_user_metadata(user_id, key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['key'] = \
            key
        return self.delete_specific_user_metadata_endpoint.call_with_http_info(**kwargs)

    def delete_user_all_metadata(
        self,
        user_id,
        **kwargs
    ):
        ...
        ## Delete metadata You can delete a specific or all metadata of a user. Metadata stores additional user information such as their preference settings. https://sendbird.com/docs/chat/platform-api/v3/user/managing-metadata/user-delete-metadata  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_user_all_metadata(user_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['user_id'] = \
            user_id
        return self.delete_user_all_metadata_endpoint.call_with_http_info(**kwargs)
    ...
    def update_specific_user_metadata(
        self,
        user_id,
        key,
        **kwargs
    ):
        """Update specific user metadata  # noqa: E501

        ## Update metadata https://sendbird.com/docs/chat/platform-api/v3/user/managing-metadata/user-update-metadata  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_specific_user_metadata(user_id, key, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            api_token (str): [optional]
            update_specific_user_metadata_request (UpdateSpecificUserMetadataRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['key'] = \
            key
        return self.update_specific_user_metadata_endpoint.call_with_http_info(**kwargs)
    ...
    def update_user_metadata(
        ...
        **kwargs
        ...
        ## Update metadata When updating existing items of the user metadata by their keys or adding new items to the metadata https://sendbird.com/docs/chat/platform-api/v3/user/managing-metadata/user-update-metadata  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def view_specific_user_metadata(
        self,
        user_id,
        key,
        **kwargs
    ):
        """Get specific user metadata  # noqa: E501

        ## Get metadata https://sendbird.com/docs/chat/platform-api/v3/user/managing-metadata/user-get-metadata  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.view_specific_user_metadata(user_id, key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['key'] = \
            key
        return self.view_specific_user_metadata_endpoint.call_with_http_info(**kwargs)
