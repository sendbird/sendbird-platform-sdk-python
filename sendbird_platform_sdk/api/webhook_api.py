...
class WebhookApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.choose_which_events_to_subscribe_to_endpoint = _Endpoint(
            ...
            root_map={
                ...
                'location_map': {
                    'api_token': 'header',
                    'choose_which_events_to_subscribe_to_data': 'body',
                },
        ...
        self.retrieve_list_of_subscribed_events_endpoint = _Endpoint(
            ...
            root_map={
                ...
                'attribute_map': {
                    'api_token': 'Api-Token',
                    'display_all_webhook_categories': 'display_all_webhook_categories',
                },
                'location_map': {
                    'api_token': 'header',
                    'display_all_webhook_categories': 'query',
                },
                'collection_format_map': {
                }
            },
    ...
    def retrieve_list_of_subscribed_events(
        ...
        **kwargs
        ...
        ## Retrieve a list of subscribed events  Retrieves a list of events for your webhook server to receive payloads for.  https://sendbird.com/docs/chat/v3/platform-api/guides/webhooks#2-retrieve-a-list-of-subscribed-events ----------------------------  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
