...
class GetDetailedOpenStatusOfAnnouncementByIdResponseOpenStatus(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GetDetailedOpenStatusOfAnnouncementByIdResponseOpenStatus - a model defined in OpenAPI
