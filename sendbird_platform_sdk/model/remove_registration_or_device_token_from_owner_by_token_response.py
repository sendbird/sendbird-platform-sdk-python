...
class RemoveRegistrationOrDeviceTokenFromOwnerByTokenResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """RemoveRegistrationOrDeviceTokenFromOwnerByTokenResponse - a model defined in OpenAPI
