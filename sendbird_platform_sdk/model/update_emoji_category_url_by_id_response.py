...
class UpdateEmojiCategoryUrlByIdResponse(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """UpdateEmojiCategoryUrlByIdResponse - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (SendBirdEmojiCategory):  # noqa: E501

        Keyword Args:
            value (SendBirdEmojiCategory):  # noqa: E501
