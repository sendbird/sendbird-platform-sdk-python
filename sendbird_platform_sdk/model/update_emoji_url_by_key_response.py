...
class UpdateEmojiUrlByKeyResponse(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """UpdateEmojiUrlByKeyResponse - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (SendBirdEmoji):  # noqa: E501

        Keyword Args:
            value (SendBirdEmoji):  # noqa: E501
