...
class RemoveARegistrationOrDeviceTokenFromAnOwnerResponse(ModelSimple):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'value': ([MarkChannelMessagesAsReadRequest],),
        }
    ...
    def __init__(self, *args, **kwargs):
        """RemoveARegistrationOrDeviceTokenFromAnOwnerResponse - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([MarkChannelMessagesAsReadRequest]):  # noqa: E501

        Keyword Args:
            value ([MarkChannelMessagesAsReadRequest]):  # noqa: E501
