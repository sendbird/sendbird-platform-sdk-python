...
class CreateAGroupChannelResponse(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """CreateAGroupChannelResponse - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (SendbirdGroupChannelDetail):  # noqa: E501

        Keyword Args:
            value (SendbirdGroupChannelDetail):  # noqa: E501
