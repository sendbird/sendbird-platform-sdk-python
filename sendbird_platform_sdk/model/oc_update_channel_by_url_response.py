...
class OcUpdateChannelByUrlResponse(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """OcUpdateChannelByUrlResponse - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (SendBirdOpenChannel):  # noqa: E501

        Keyword Args:
            value (SendBirdOpenChannel):  # noqa: E501
