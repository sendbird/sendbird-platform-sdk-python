...
class SendFileMessageRequestBody(ModelNormal):
    ...
    def _from_openapi_data(cls, files, *args, **kwargs):  # noqa: E501
        """SendFileMessageRequestBody - a model defined in OpenAPI

        Args:
            files (SendbirdFile):

        Keyword Args:
            message_type (str): Specifies the type of the message. The value of FILE represents a file message.. defaults to "FILE", must be one of ["FILE", ]  # noqa: E501
