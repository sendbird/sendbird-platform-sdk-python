...
class SendTextMessageRequestBody(ModelNormal):
    ...
    def _from_openapi_data(cls, message, *args, **kwargs):  # noqa: E501
        """SendTextMessageRequestBody - a model defined in OpenAPI

        Args:
            message (str):

        Keyword Args:
            message_type (str): Specifies the type of the message. The value of MESG represents a text message.. defaults to "MESG", must be one of ["MESG", ]  # noqa: E501
        ...
        message_type = kwargs.get('message_type', "MESG")
