...
class MigrateMessagesAdminMessageRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, message, timestamp, *args, **kwargs):  # noqa: E501
        """MigrateMessagesAdminMessageRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            message_type (str): defaults to "ADMM", must be one of ["ADMM", ]  # noqa: E501
