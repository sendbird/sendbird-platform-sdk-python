...
class V3ApplicationsSettingsByChannelCustomTypeCustomTypeBanBannedList(ModelNormal):
    ...
    def _from_openapi_data(cls, user_id, *args, **kwargs):  # noqa: E501
        """V3ApplicationsSettingsByChannelCustomTypeCustomTypeBanBannedList - a model defined in OpenAPI
