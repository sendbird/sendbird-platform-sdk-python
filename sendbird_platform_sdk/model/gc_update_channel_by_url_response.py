...
class GcUpdateChannelByUrlResponse(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """GcUpdateChannelByUrlResponse - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (SendBirdGroupChannel):  # noqa: E501

        Keyword Args:
            value (SendBirdGroupChannel):  # noqa: E501
