...
class JoinChannelsResponse(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """JoinChannelsResponse - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (SendBirdGroupChannelCollection):  # noqa: E501

        Keyword Args:
            value (SendBirdGroupChannelCollection):  # noqa: E501
