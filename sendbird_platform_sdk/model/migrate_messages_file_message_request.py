...
class MigrateMessagesFileMessageRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user_id, url, timestamp, *args, **kwargs):  # noqa: E501
        """MigrateMessagesFileMessageRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            message_type (str): defaults to "FILE", must be one of ["FILE", ]  # noqa: E501
        ...
        message_type = kwargs.get('message_type', "FILE")
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_id, url, timestamp, *args, **kwargs):  # noqa: E501
        """MigrateMessagesFileMessageRequest - a model defined in OpenAPI
