...
class MigrateMessagesTextMessageRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user_id, message, timestamp, *args, **kwargs):  # noqa: E501
        """MigrateMessagesTextMessageRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            message_type (str): defaults to "MESG", must be one of ["MESG", ]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_id, message, timestamp, *args, **kwargs):  # noqa: E501
        """MigrateMessagesTextMessageRequest - a model defined in OpenAPI
