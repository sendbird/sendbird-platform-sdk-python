...
class SendBirdGroupChannelInviter(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'session_tokens': ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}],),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SendBirdGroupChannelInviter - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            session_tokens ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): [optional]  # noqa: E501
