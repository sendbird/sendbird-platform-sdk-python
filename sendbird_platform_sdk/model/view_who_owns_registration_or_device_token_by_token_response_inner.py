...
class ViewWhoOwnsRegistrationOrDeviceTokenByTokenResponseInner(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ViewWhoOwnsRegistrationOrDeviceTokenByTokenResponseInner - a model defined in OpenAPI
