...
class SendAdminMessageRequestBody(ModelNormal):
    ...
    def _from_openapi_data(cls, message, *args, **kwargs):  # noqa: E501
        """SendAdminMessageRequestBody - a model defined in OpenAPI

        Args:
            message (str):

        Keyword Args:
            message_type (str): Specifies the type of the message. The value of ADMM represents an admin message.. defaults to "ADMM", must be one of ["ADMM", ]  # noqa: E501
        ...
        message_type = kwargs.get('message_type', "ADMM")
