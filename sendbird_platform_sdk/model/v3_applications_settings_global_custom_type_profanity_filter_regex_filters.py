...
class V3ApplicationsSettingsGlobalCustomTypeProfanityFilterRegexFilters(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """V3ApplicationsSettingsGlobalCustomTypeProfanityFilterRegexFilters - a model defined in OpenAPI
