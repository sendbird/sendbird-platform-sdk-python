...
def lazy_import():
    ...
    globals()['SendbirdSortedMetaarrayInner'] = SendbirdSortedMetaarrayInner


class SendbirdSortedMetaarray(ModelSimple):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'value': ([SendbirdSortedMetaarrayInner],),
        }
    ...
    def __init__(self, *args, **kwargs):
        """SendbirdSortedMetaarray - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([SendbirdSortedMetaarrayInner]):  # noqa: E501

        Keyword Args:
            value ([SendbirdSortedMetaarrayInner]):  # noqa: E501
