...
class ListDataExportsByMessageChannelOrUserResponseExportedData(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ListDataExportsByMessageChannelOrUserResponseExportedData - a model defined in OpenAPI
