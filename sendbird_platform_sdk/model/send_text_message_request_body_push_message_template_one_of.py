...
class SendTextMessageRequestBodyPushMessageTemplateOneOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SendTextMessageRequestBodyPushMessageTemplateOneOf - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            title (str): Specifies the title of the custom push notification template. You can customize the title using the variables sender_name and message, which can be later replaced with corresponding real values when the template is sent out as a notification request to FCM, HMS, or APNs.. [optional]  # noqa: E501
