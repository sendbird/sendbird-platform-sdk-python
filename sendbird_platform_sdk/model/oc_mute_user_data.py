...
class OcMuteUserData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user_id, seconds, description, *args, **kwargs):  # noqa: E501
        """OcMuteUserData - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_id, seconds, description, *args, **kwargs):  # noqa: E501
        """OcMuteUserData - a model defined in OpenAPI
