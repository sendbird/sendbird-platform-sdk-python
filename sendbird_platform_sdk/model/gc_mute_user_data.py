...
class GcMuteUserData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, channel_url, user_id, seconds, description, *args, **kwargs):  # noqa: E501
        """GcMuteUserData - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, channel_url, user_id, seconds, description, *args, **kwargs):  # noqa: E501
        """GcMuteUserData - a model defined in OpenAPI
