...
class CreateABotRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, bot_callback_url, bot_nickname, bot_profile_url, bot_type, bot_userid, is_privacy_mode, *args, **kwargs):  # noqa: E501
        """CreateABotRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, bot_callback_url, bot_nickname, bot_profile_url, bot_type, bot_userid, is_privacy_mode, *args, **kwargs):  # noqa: E501
        """CreateABotRequest - a model defined in OpenAPI
