...
class TranslateMessageIntoOtherLanguagesResponse(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """TranslateMessageIntoOtherLanguagesResponse - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (SendBirdMessageResponse):  # noqa: E501

        Keyword Args:
            value (SendBirdMessageResponse):  # noqa: E501
