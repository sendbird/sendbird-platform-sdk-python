...
class UpdatePushPreferencesRequestDndSchedulesInnerTimeWindowsInner(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """UpdatePushPreferencesRequestDndSchedulesInnerTimeWindowsInner - a model defined in OpenAPI
